...
For an in-depth guide on how to deploy the Project Navigator UI, please refer to the [local kubernetes deployment](./docs/local-deployment-guide.md) documentation.

To quickly enable the Project Navigator UI in your Kind cluster, you can use the following command:
