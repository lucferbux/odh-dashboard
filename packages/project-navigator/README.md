# Project Navigator UI

## Overview

The Project Navigator UI is a standalone web app for Project Navigator. In this repository, you will find the frontend and backend for the Project Navigator UI.

## Contributing

You can check the [contributing guidelines] for more information on how to contribute to the Project Navigator UI.
...
You can find the OpenAPI specification for the Project Navigator UI in the [openapi](./api/openapi) directory.

## Targeted environments

There are two main deployment modes that the Project Navigator UI supports:
...
The following environment variables are used to configure the deployment and development environment for the Project Navigator UI. These variables should be defined in a `.env.local` file in the `clients/ui` directory of the project. **This values will affect the build and push commands**.
...
- **Default Value**: `ghcr.io/your-org/project-navigator/ui:latest`
- **Example**: `IMG_UI=ghcr.io/your-org/project-navigator/ui:latest`

### `IMG_UI_STANDALONE`

- **Description**: Specifies the image name and tag for the UI (with BFF) in **standalone mode**, used for local kind deployment.
- **Default Value**: `ghcr.io/your-org/project-navigator/ui-standalone:latest`
- **Example**: `IMG_UI_STANDALONE=ghcr.io/your-org/project-navigator/ui-standalone:latest`
...
- **Default Value**: `ghcr.io/your-org/project-navigator/ui-federated:latest`
- **Example**: `IMG_UI_FEDERATED=ghcr.io/your-org/project-navigator/ui-federated:latest`
...
IMG_UI=quay.io/<personal-registry>/project-navigator-ui:latest
IMG_UI_STANDALONE=quay.io/<personal-registry>/project-navigator-ui-standalone:latest
...
For more information on how to deploy the Project Navigator UI, please refer to the [Mod arch UI] documentation.
