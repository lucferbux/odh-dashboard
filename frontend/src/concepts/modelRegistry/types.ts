...
export type ModelRegistryListParamsOptions = Omit<ModelRegistryListParams, 'nextPageToken'> & {
  page?: number;
};

export type ModelRegistryListPaged<T extends ModelRegistryBase> = ModelRegistryListParams & {
  items?: T[];
};
