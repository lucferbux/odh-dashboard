h1. RFE: Clusterless Development Mode for Downstream Dashboard

h2. PARENT EPIC: Clusterless Development Mode
...
h2. EPIC 1: Backend Mock Mode Infrastructure
...
h4. Story 1.1: Add Mock Mode Environment Variables and Configuration

*Description*:

h5. Description of the enhancement
...
h4. Story 1.2: Create Mock Data Provider Infrastructure
...
h4. Story 1.3: Implement Pass-Through API Mock Layer
...
h4. Story 1.4: Implement Feature-Specific Mock Control
...
h4. Story 1.5: Create Mock Data for Core Dashboard Resources
...
h2. EPIC 2: Frontend SDK Mocking & Mock Data Provider
...
h4. Story 2.1: Create SDK Mock Provider Infrastructure
...
h4. Story 2.2: Implement Mock k8sGetResource
...
h4. Story 2.3: Implement Mock k8sCreateResource, k8sUpdateResource, k8sPatchResource
...
h4. Story 2.4: Implement Mock k8sDeleteResource and k8sListResource
...
h4. Story 2.5: Create Scaffolding for Frontend Mock Data
...
h4. Story 2.6: Implement Mock Mode Detection and Initialization
...
h2. EPIC 3: Documentation & Developer Experience
...
h4. Story 3.1: Create Mock Mode Setup Guide
...
h4. Story 3.2: Create Mock Data Creation Guide
...
h4. Story 3.3: Create Mock Mode Configuration Reference
...
h4. Story 3.4: Update Development Workflow Documentation
...
h4. Story 3.5: Create Mock Mode Demo Video or Tutorial
...
This RFE provides a comprehensive plan to implement clusterless development for the RHOAI downstream dashboard, *focused on Core dashboard resources only*. The work is organized into *3 main Epics with 16 active Stories*:

h3. Active Work

* *Epic 1* (Backend Mock Infrastructure): 5 Stories
* *Epic 2* (Frontend SDK Mocking): 6 Stories
* *Epic 3* (Documentation): 5 Stories

h3. Scope Summary

*In Scope (Core Features)*:
* User authentication and profile
* Dashboard Configuration (OdhDashboardConfig)
* Application catalog (OdhApplication)
* Documentation and Quick Starts (OdhDocument, OdhQuickStart)
* Basic K8s resources needed for Core functionality (Namespaces, Secrets, ConfigMaps)

*Out of Scope (Feature-Specific)*:
* Notebooks/Workbenches mock data
* Model Serving mock data
* Data Science Projects advanced features
* Data Connections beyond basic secrets
...
The implementation follows patterns established in the modular architecture's model-registry BFF while adapting them to the dashboard's Fastify backend architecture. All Stories include clear acceptance criteria, testing requirements, and relevant codebase references.

*Key Principles*:
* Focus on 80% of common Core development workflows
* Enable developers to run dashboard locally without K8s cluster for Core features
* Maintain clear boundaries between Core and feature-specific functionality
* Provide extensibility for future expansion to feature-specific mock data

*Estimated Timeline*: 2-3 months with 2-3 developers (reduced from 3-4 months due to reduced scope)

h3. Success Metrics Alignment

This refined scope directly addresses the success criteria:
* (/) Developers can run dashboard locally without K8s cluster (for Core features)
* (/) Mock mode covers 80% of common development workflows (via Core resources)
* (/) Developer setup time reduced by 50% (streamlined onboarding)
* (/) Clear documentation for adding new mock data (focused on Core)
* (/) Environment variables allow granular control of mocking and feature enablement

h3. Next Steps

Since the Jira MCP integration is having issues, we recommend:

# Create the Epic and Stories manually in Jira using the structure above
# Focus initial implementation on Epics 1, 2, and 3 only
# Adjust priorities and assignments based on team capacity
# Consider using the Jira template (RHOAIENG-8770) for the main Epic if creating via UI

The updated plan is technically sound, appropriately scoped, and follows your team's Jira creation guidelines. Each active Story has clear acceptance criteria and references to relevant parts of the codebase.
